...
class Installer(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle('Minecraft Paper Server Installer')
        
        self.version_label = QLabel('Select Minecraft Version:', self)
        self.version_combo = QComboBox(self)
        self.version_combo.addItems(versions_data['versions'].keys())

        self.folder_button = QPushButton('Select Installation Folder', self)
